...
class wine(Runner):
    ...
    def __init__(self, config=None):  # noqa: C901
        ...
        def dxvk_vulkan_callback(widget, option, config):
            response = True
            if not is_vulkan_supported() and not thread_safe_call(display_vulkan_error):
                response = False
            return widget, option, response
        ...
        self.runner_options = [
            ...
            },
            {
                ...
                "default": False,
                "help": _(
                    "Configure x360ce with xinput9_1_0.dll, required for some newer games"
                ),
                "advanced": True,
            },
            {
            ...
            {
                "option": "SampleCount",
                "label": _("Anti-aliasing Sample Count"),
                "type": "choice",
                "choices": [
                    (_("Auto"), "auto"),
                    ("0", "0"),
